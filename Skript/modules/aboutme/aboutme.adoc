...
ifdef::backend-revealjs[=== Lebenslauf]
...
ifdef::backend-revealjs[=== Forschungsinteressen]
...
ifdef::backend-revealjs[=== Curriculum Vitae]
...
ifdef::backend-revealjs[=== Research Interests]
**Research interests:** 
